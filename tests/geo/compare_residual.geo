...
//Merge "tests/msh/triangle-tri56-ref.msh";
Merge "tests/msh/triangle-quad44-ref.msh";
/*
Solution file first:
...
// Your mesh files
//Merge "tests/msh/triangle-tri56-val.msh";
Merge "tests/msh/triangle-quad44-val.msh";
/*
